...
We open the command prompt and __docker ps__ to view the running containers
...
<br>
Access to the router container.
This container is where we work on
<br>Then we need to delete all previous rules in this router. We use:
<br>__iptables -F
<br>iptables -X__
...
<br>
We can see that __INPUT__ is in __ACCEPT__. We need to change it using:
